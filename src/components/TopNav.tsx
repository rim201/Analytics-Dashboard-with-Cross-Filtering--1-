            ...
            <div className="relative" ref={wrapRef}>
              ...
              {panelOpen && (
                <div className="absolute right-0 top-full mt-2 w-[min(100vw-1rem,48rem)] min-h-[16rem] max-h-[min(85vh,48rem)] overflow-hidden rounded-2xl border-2 border-gray-300 bg-white shadow-2xl z-50 flex flex-col">
                  ...
                  <div className="overflow-y-auto flex-1 p-3 min-h-0 bg-white space-y-3">
                        ...
                        {inAppUnread.map((n) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <p className="text-sm text-gray-700 mt-1 line-clamp-2">{n.alertTitle}</p>
                              <p className="text-xs text-gray-500 mt-1">{formatRequestTime(n.createdAt)}</p>
                              <button
                                type="button"
                                disabled={busy}
                    ...
                    {canAccessAlerts && pendingStaffAlerts.length > 0 && (
                      <ul className={inAppUnread.length > 0 ? 'space-y-3 pt-1 border-t border-gray-200' : 'space-y-3'}>
